def return_case_df():
    ...
    ste_height_correction   = -0.5#1
    ste_rotation_correction =  0#-1.0
    ste_x_correction        = -4.5#-2.5 + 2
    ...
    z05_rotation_correction = -2.0 + 1.0
    z05_x_correction        = -0.5

    z10_height_correction   =  0.1 + 0.5
    z10_rotation_correction =  0.0 - 2.0
    z10_x_correction        =  0.0 + 23.0
